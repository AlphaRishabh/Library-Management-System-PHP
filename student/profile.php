                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" action="edit_student_details.php?id=<?php echo $rollno ?>" method="post">
                                    ...
                                    <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name = "Gender" tabindex="1" value="SC" data-placeholder="Select Gender" class="span6">
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2023Library Management System </b>All rights reserved.
            </div>
        </div>
...
$sql1="update MYLMS.user set Name='$name', Gender='$Gender', EmailId='$email', MobNo='$mobno', Password='$pswd' where RollNo='$rollno'";
